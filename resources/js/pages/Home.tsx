    ...
    <AppLayout>
      <Layout>
        ...
        <section className="relative h-[600px] flex items-center overflow-hidden">
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10 text-white">
            <motion.div
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <Link href="/articles" className="text-primary font-medium flex items-center gap-2 hover:gap-3 transition-all">
                  {t('readMore')} {isRtl ? <ArrowRight className="rotate-180 h-4 w-4" /> : <ArrowRight className="h-4 w-4" />}
                </Link>
              </motion.div>
            </div>
